...
public class CustomPaginationAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public CustomPaginationAdapter(Context context,ArrayList<Song> dataArrayList){
